...
import { getDiscountCaption, getDiscountPercentLabel, isGlobalDiscountEnabled } from "@/lib/discount";
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 py-14 md:grid-cols-2 md:items-center">
          <div className="relative z-10">
            ...
            {isGlobalDiscountEnabled() ? (
              <div className="mt-5 inline-flex rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm shadow-soft">
                <span>
